...
class _RichCodeFieldState extends State<RichCodeField>
  ...
  late RichCodeEditingController _controller;
      ...
      if (_effectiveController.value.text.runes.length > widget.maxLength!) {
        return effectiveDecoration.copyWith(
          ...
          counterStyle: effectiveDecoration.errorStyle ??
              // themeData.textTheme.labelLarge.copyWith(color: themeData.errorColor),
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData themeData = Theme.of(context);
    final TextStyle style =
        themeData.textTheme.titleMedium?.merge(widget.style) ??
            widget.style ??
            TextStyle();
    final Brightness keyboardAppearance =
